exports.execute = async (client, message, args) => {
    ...
    else return message.reply(`**${users[Math.floor(Math.random() * users.length)]}** somehow rolled into your hands and you sold it for **${beg.amount}** 💸. Now you have **${beg.after}** 💸.`);
};
